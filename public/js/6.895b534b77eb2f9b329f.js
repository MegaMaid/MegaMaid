...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    computed: _extends({
        isManualEmailSetting: function isManualEmailSetting() {
            console.log(this.$store.getters['config/email'].type);
